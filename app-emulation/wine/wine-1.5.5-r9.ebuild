...
src_prepare() {
	...
	epatch "${FILESDIR}"/0001-ntdll-Improve-performace-of-heap-allocation-v2.patch #lol
	epatch "${FILESDIR}"/0002-imm32-Avoid-deadlock-when-destroying-thread-data.patch #lol
	epatch_user #282735
	eautoreconf
